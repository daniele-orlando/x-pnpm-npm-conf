	...
	addEnv(env) {
		...
		Object.keys(env)
			...
			.forEach(x => {
                ...
                // Removes PNPM array settings from those incorrectly parsed by NPM
		// and re-exported as ENV variables.
		delete conf['hoist-pattern'];
		delete conf['public-hoist-pattern'];
